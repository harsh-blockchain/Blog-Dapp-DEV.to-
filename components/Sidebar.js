...
const styles = {
  ...
  icon: `text-2xl text-gray-700 h-6 space-x-2 flex items-center font-semibold`,
  name: `text-xl font-bold text-gray-700`,
  lower: `flex flex-row gap-7 mt-[330px] items-center`,
};
